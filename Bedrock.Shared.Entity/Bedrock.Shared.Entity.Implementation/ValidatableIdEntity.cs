...
{
    [Serializable]
    public abstract class ValidatableIdEntity<TEntity, TKey> : EntityIdBase<TEntity, TKey>, IBedrockEntity, IBedrockIdEntity<TKey>, IValidatableEntity
        where TEntity : ValidatableIdEntity<TEntity, TKey>, IValidatableEntity
